...
/// This is a test harness function to be called from within a test in each backend implementing crate
/// to verify that the given implemented backend fulfils the contracts required to be used as an Eidetic
/// backend.
///
/// # Generics
/// T is the backend type which should implement the Backend trait for all supported data types.
